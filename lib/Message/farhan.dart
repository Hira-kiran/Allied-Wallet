...
class FarhanConversation extends StatefulWidget {
  const FarhanConversation({super.key});

  @override
  State<FarhanConversation> createState() => _FarhanConversationState();
}

class _FarhanConversationState extends State<FarhanConversation> {
                                ...
                                child: Column(
                                  children: [
                                    Image(
                                      height: 200.h,
                                      image:
                                          const AssetImage("images/nomsg.webp"),
                                    ),
                                    Padding(
